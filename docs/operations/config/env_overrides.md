...
export VELOFLUX_LOGGING__DISABLE_TIMESTAMP=true
...
export VELOFLUX_LOGGING__SYSLOG__NETWORK=unixgram
export VELOFLUX_LOGGING__SYSLOG__ADDRESS=/var/run/syslog
